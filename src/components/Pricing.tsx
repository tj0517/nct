  ...
  return (
    <section className="border-t border-main px-16 py-16 flex flex-col gap-16 w-full">
      <div className="flex flex-col items-start">
        <p className="font-inter text-base text-main">PRICING</p>
        <h2 className="font-fraunces font-bold text-[64px] text-main leading-normal">
          Simple, transparent pricing.
        </h2>
      </div>

      <div className="grid grid-cols-[0.75fr_1fr] gap-x-9">
        {/* Free intro card */}
        <div data-pricing-free className="bg-main rounded-bl-[100px] rounded-tr-[100px] p-16 flex flex-col gap-4 overflow-hidden">
          <div className="flex flex-col">
            <p className="font-inter text-base text-second-bg">START HERE</p>
            <p className="font-fraunces font-bold text-[64px] text-main-bg leading-normal">
              Free
            </p>
          </div>
          <p className="font-fraunces font-normal text-2xl text-main-bg">
            First 60-minute consultation
          </p>
          <p className="font-fraunces font-light text-2xl text-second-bg leading-normal">
        ...
        <div className="flex flex-col">
          {pricingRows.map((row, i) => (
            <div
              key={i}
              data-pricing-row
              className="flex-1 flex items-center gap-[10px] border-b border-main p-4 overflow-hidden"
            >
              <div className="flex-1">
                <p className="font-fraunces font-bold text-2xl text-main leading-normal">
                  {row.name}
                </p>
              </div>
              <div className="flex-1 flex items-center justify-center">
                <p className="font-inter text-lg text-main">{row.type}</p>
              </div>
              <div className="flex-1 flex items-center justify-center">
                <p className="font-fraunces font-bold text-2xl text-main">
                  {row.price}
                </p>
              </div>
            </div>
