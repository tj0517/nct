...
export default function CourseHelp({ dict }: { dict: CourseHelpDict }) {
  return (
    <section className="w-full py-16 md:py-28 border-t border-main/10">
      <div className="max-w-[1440px] mx-auto px-5 md:px-16 grid grid-cols-1 md:grid-cols-[minmax(0,1fr)_minmax(0,1.4fr)] gap-8 md:gap-20 items-start">
