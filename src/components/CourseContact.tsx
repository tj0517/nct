...
export default function CourseContact({ dict }: { dict: ContactFormDict }) {
  return (
    <section id="contact" className="w-full px-5 md:px-16 py-16 md:py-28 border-t border-main/10 scroll-mt-20">
      <div className="max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-[1fr_0.85fr] gap-10 md:gap-16 items-start">
